<template>
  <div class="cart">
    <RouterLink to="/cart" class="curr" href="#"> <i class="iconfont icon-cart"></i><em v-if="store.getters['cart/validTotal']">{{store.getters['cart/validTotal']}}</em> </RouterLink>
    <div class="layer" v-if="$store.getters['cart/validTotal']&&$route.path!=='/cart'">
      <div class="list">
        <div class="item" v-for="i in $store.getters['cart/validList']" :key="i.skuld">
          ...
          <i @click="deleteCart(i.skuId)" class="iconfont icon-close-new"></i>
        </div>
      </div>
      <div class="foot">
        <div class="total">
