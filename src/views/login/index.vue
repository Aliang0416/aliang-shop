<template>
  ...
  <section class="login-section">
    <div class="wrapper">
      <nav>
        <a @click="activeName='account'" :class="[activeName ==='account' ? 'active' : '']" href="javascript:;">账户登录</a>
        <a @click="activeName='qrcode'" :class="[activeName ==='qrcode' ? 'active' : '']" href="javascript:;">扫码登录</a>
      </nav>
      <!-- 表单 -->
      <!-- <div v-if="activeName==='account'" class="account-box"></div> -->
