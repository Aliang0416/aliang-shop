<template>
  <div class="checkout-address">
    ...
    <XtxDialog title="切换收货地址" v-model:visible="dialogVisible">
      <div :class="{active:selectedAddress&&item.id===selectedAddress.id}" class="text item" @click="selectaddress(item)" v-for="item in list" :key="item.id">
        <ul>
...
export default {
  ...
  setup (props, { emit }) {
    ...
    return { showAddress, dialogVisible, openDialog, confirmAddress, selectaddress, selectedAddress, addressEdit, openAddressEdit, successHandler }
  }
}
</script>
