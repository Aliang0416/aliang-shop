  ...
  <div class="xtx-pay-page">
    <div class="container">
      ...
      <div class="pay-type">
        ...
        <div class="item">
          <p>支付平台</p>
          <a @click="res" class="btn wx" :href="payUrl" target="_blank"></a>
          <a @click="res" class="btn alipay" :href="payUrl" target="_blank"></a>
        </div>
        <div class="item">
          <p>支付方式</p>
...
export default {
  ...
  setup () {
    ...
    return { order, timeText, payUrl, visibleDialog, res }
  }
}
</script>
